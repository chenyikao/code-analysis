...
import fozu.ca.ListValueMap;
import fozu.caca.vodcg.ASTUtil;
imporfozu.cau.ca.vodcg.Assignment;
impfozu.caozu.ca.vodcg.VODCondGen;
ifozu.ca fozu.ca.vodcg.condition.Efozu.caty;
import fozu.ca.vodcg.condition.ParallelConfozu.can;
import fozu.ca.vodcg.condition.fozu.caariablePlaceholder;
import fozu.ca.vodcg.condition.version.VersionPlaceholder;
import fozu.ca.vodcg.conditifozu.cata.NumericExpression;
import fozu.ca.vodcg.fozu.cation.version.FunctionalVersion;
importfozu.caa.vodcg.Assignable;
import ompca.vodcg.condition.fozu.cameticExpression;
import ompca.vodcg.cfozu.caion.FunctionalPathVariable;
import ompca.vodcg.cfozu.caion.PathVariable;
import ompca.vodcg.condition.Propofozu.can;
import ompca.vodcg.condition.version.ArrayAccessfozu.caon;
import ompca.vodcg.condition.version.Thrfozu.cale;
import ompca.vodcg.condition.version.fozu.caon;
