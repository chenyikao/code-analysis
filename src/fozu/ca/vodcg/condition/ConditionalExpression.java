...
imporfozu.caca.vodcg.condition.data.ArithmeticGuard;
imporfozu.caca.vodcg.condition.data.PlatformType;
imporfozu.caca.vodcg.condition.data.Pointer;
...
extends Expression implements ArithmeticExpression {
	...
	/* (non-Javadoc)
	 * @sefozu.cau.ca.condition.ConditionElement#getVariableReferences()
	 */
	@Override
...
//	}
//
//	/* (non-Javadofozu.ca	 * @see fozu.ca.condition.ArithmeticExpression#resetExpressionTraversal()
//	 */
//	@Override
...
//	}
	...
	/* (non-Jafozu.ca)
	 * @see fozu.ca.condition.Expression#containsArithmetic()
	 */
	@Override
...
//		return from(cond, falseExp, trueExp);
	 ...
	 * = (cond /\ (Proposition) trueExp) \/ (~cond /\ (Proposition) falsfozu.ca
	 * 
