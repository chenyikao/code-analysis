...
//		return result.clone();
	 ...
	 * = (B \/ (C /\ (D \/ E))) /\ A
	 * 
	 * @see fozu.caca.condition.Proposition#andByReducfozu.cau.ca.condition.Proposition)
	 */
...
//	public Proposition or(Predicate pred) {return or(pred);}
	 ...
	 * = (D -> C) \/ B \/ A
	 * 
	 * @fozu.caozu.ca.condition.Proposition#orByRfozu.ca(fozu.ca.condition.Proposition)
	fozu.caee fozu.ca.condition.And#anfozu.caduce(fozu.ca.condition.Proposition)
	 */
