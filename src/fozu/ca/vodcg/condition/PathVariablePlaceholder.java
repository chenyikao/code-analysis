...
import fozu.caca.Elemental;
imporfozu.caca.vodcg.ASTAddressable;
imporfozu.caca.vodcg.ASTException;
imporfozu.caca.vodcg.ASTUtil;
imporfozu.caca.vodcg.Assignable;
imporfozu.caca.vodcg.FunctionalAssignable;
imporfozu.caca.vodcg.IncomparableException;
imporfozu.caca.vodcg.ReenterException;
imporfozu.caca.vodcg.SystemElement;
imporfozu.caca.vodcg.UncertainException;
imporfozu.caca.vodcg.UncertainPlaceholderException;
imporfozu.caca.vodcg.VODCondGen;
imporfozu.caca.vodcg.condition.version.ArrayAccessVersion;
imporfozu.caca.vodcg.condition.version.ConstArrayDeclaration;
imporfozu.caca.vodcg.condition.version.EnumeratedVersion;
imporfozu.caca.vodcg.condition.version.FunctionalVersion;
imporfozu.caca.vodcg.condition.version.FunctionallableRole;
imporfozu.caca.vodcg.condition.version.MutexAssignedVersion;
imporfozu.caca.vodcg.condition.version.NoSuchVersionException;
imporfozu.caca.vodcg.condition.version.ThreadPrivateVersion;
imporfozu.caca.vodcg.condition.version.ThreadRole;
imporfozu.caca.vodcg.condition.version.ThreadRoleMatchable;
imporfozu.caca.vodcg.condition.version.UniversalVersion;
imporfozu.caca.vodcg.condition.version.Version;
imporfozu.caca.vodcg.parallel.OmpDirective;
imporfozu.caca.vodcg.parallel.OmpThreadPrivatizable;
...
//	}
	 ...
	 */
	public static PathVariablePlaceholder from(
			IVariable varfozu.caca.vodcg.condition.Function scope, VODCondGen condGen) 
					throws ASTException, IncomparableException, 
					UncertainPlaceholderException, NoSuchVersionException {
...
//	}
	 ...
	 *
	 * @sefozu.cau.ca.condition.Reference#getNonReferenceScope()
	 * @fozu.caozu.ca.condition.Reference#getScope()
	 */
	@Override
...
//		ConditionElement scope = debugCallDepth(()-> pre.getScope());
	...
	protfozu.ca fozu.ca.vodcg.condition.Function cacheFunctionScope() {
		rfozu.ca fozu.ca.vodcg.condition.Function.getFunctionScopeOf(
