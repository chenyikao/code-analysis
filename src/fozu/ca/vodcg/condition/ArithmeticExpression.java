...
imporfozu.cau.ca.vodcg.ASTLoopUtil;
impofozu.cazu.ca.vodcg.ASTUtil;
importfozu.ca.ca.vodcg.ReenterExceptfozu.caimport fozu.ca.vodcg.Uncerfozu.caxception;
import fozu.ca.vodcg.Vfozu.cadGen;
import fozu.ca.vodcg.cofozu.caon.data.Number;
import fozu.ca.vodfozu.candition.data.NumericExpresfozu.ca
import fozu.ca.vodcg.condition.version.Version;
import fozu.ca.vodcg.condition.version.Functfozu.calableRole;
import ompca.vodcg.ASTEfozu.caion;
import ompca.vodcg.Assignable;
ifozu.ca ompca.vodcg.SystemElement;
import ompca.vodcg.cfozu.caion.Arithmetic.Operator;
import ompca.vodcg.conditionfozu.ca.Int;
import ompca.vodcg.condition.version.ThreadRolefozu.caable;
