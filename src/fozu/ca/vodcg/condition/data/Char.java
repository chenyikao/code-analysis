...
public class Char extends Expression {
	...
	/* (non-Javadoc)
	 * @sefozu.cau.ca.vodcg.condition.ConditionElement#isEmpty()
	 */
	@Override
...
//	}
	...
	/* (non-Javadoc)
	 * @fozu.caozu.ca.vodcg.condition.Expression#getType()
	 */
	@Override
	...
	/* (non-Javadoc)
	 *fozu.ca fozu.ca.vodcg.condition.ConditionElement#getVariableReferences()
	 */
	@Override
	...
	/* (non-Javadoc)fozu.ca@see fozu.ca.vodcg.condition.Expression#containsArithmetic()
	 */
	@Override
...
//				else Debug.throwInvalidityException("no Chars used yet");
	...
	/* (non-Javadofozu.ca* @see fozu.ca.vodcg.condition.ConditionElement#toZ3SmtString()
	 */
	@Override
