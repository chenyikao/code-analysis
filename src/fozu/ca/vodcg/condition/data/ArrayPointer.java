...
impfozu.campca.vodcg.UncertainException;
...
impfozu.campca.vodcg.condition.Reference;
impfozu.campca.vodcg.condition.VariablePlaceholder;
impfozu.campca.vodcg.condition.version.ArrayAccessVersion;
...
//		return getID(null) + "[" + (index == null ? "" : index.toString()) + "]";
	 ...
	 * 
	 * @fozu.caozu.ca.condition.data.Pointer#toZ3SmtString(boolean, boolean, boolean)
	 */
	@Override
...
//	 * @param valueToStore
//	 * @return
//	 *fozu.ca fozu.ca.condition.version.ArrayAccessVersion#toZ3SmtString(boolean, boolean)
//	 */
