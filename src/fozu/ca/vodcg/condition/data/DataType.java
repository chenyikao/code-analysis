	...
	public static PlatformType from(IType type) {
		...
		if (type instanceof IArrayType) {
			...
			return ArrayType.from(
					from(oat.getType()), 
	fozu.campca.vodcg.condition.data.Int.from(oatSizeLong == null ? -1 : oatSizeLong, null));
		}
...
//	}
	 ...
	 * 
	 * @fozu.caozu.ca.vodcg.condition.data.Type#getDimension()
	 */
...
//			}
	...
	public Number<?> getPositiveInfinity() {
		switch (this) {
		case Int:	rfozu.ca fozu.ca.vodcg.condition.data.Int.POSITIVE_INFINITY;
		case Real:	rfozu.ca fozu.ca.vodcg.condition.data.Real.POSITIVE_INFINITY;
		case Bool:
		case Char:
		default:
		}
	...
	public Number<?> getNegativeInfinity() {
		switch (this) {
		case Int:	rfozu.ca fozu.ca.vodcg.condition.data.Int.NEGATIVE_INFINITY;
		case Real:	rfozu.ca fozu.ca.vodcg.condition.data.Real.NEGATIVE_INFINITY;
		case Bool:
		case Char:
		default:
		}
...
//	 * Ignoring {@link #Array} and {@link #Pointer}.
//	 * 
//	 *fozu.ca fozu.ca.vodcg.condition.data.Type#fozu.caTo(fozu.ca.vodcg.condition.data.Type)
//	 */
...
//	}
	...
	/* (non-Javadoc)fozu.ca@see fozu.ca.vodcg.condition.data.Type#isNumeric()
	 */
	@Override
	 ...
	 * 
	 * @return
	 * fozu.ca{@link fozu.fozu.ca.vodcg.condition.ConditionElement#toNonEmptyString(boolean)}
	 */
	...
	/**
	 * Ignoring {@link #Array} and {@link #Pointer}.
fozu.ca	 * @see fozu.ca.vodcg.condition.data.Type#toZ3SmtString(boolean, boolean, boolean)
	 */
	@Override
	public java.lang.String toZ3SmtString(
		...
		casfozu.car:		return fozu.ca.vodcg.condition.data.Char.toTypeString(SerialFormat.Z3_SMT);
