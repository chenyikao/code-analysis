...
import fozu.caca.Addressable;
imporfozu.cau.ca.MappableList;
impfozu.campca.vodcg.Assignable;
impfozu.campca.vodcg.IncomparableException;
impfozu.campca.vodcg.ReenterException;
impfozu.campca.vodcg.SystemElement;
impfozu.campca.vodcg.UncertainPlaceholderException;
impfozu.campca.vodcg.VODCondGen;
impfozu.campca.vodcg.condition.data.ArithmeticGuard;
impfozu.campca.vodcg.condition.data.ArrayType;
impfozu.campca.vodcg.condition.data.PlatformType;
impfozu.campca.vodcg.condition.data.PointerType;
impfozu.campca.vodcg.condition.version.FunctionalVersion;
impfozu.campca.vodcg.condition.version.FunctionallableRole;
impfozu.campca.vodcg.condition.version.MutexAssignedVersion;
impfozu.campca.vodcg.condition.version.NoSuchVersionException;
impfozu.campca.vodcg.condition.version.ThreadPrivateVersion;
impfozu.campca.vodcg.condition.version.ThreadRole;
impfozu.campca.vodcg.condition.version.ThreadRoleMatchable;
impfozu.campca.vodcg.condition.version.UniversalVersion;
impfozu.campca.vodcg.condition.version.Version;
impfozu.campca.vodcg.condition.version.VersionEnumerable;
impfozu.campca.vodcg.condition.version.VersionPlaceholder;
...
//	}
	...
	public static VariablePlaceholder<? extends Variable> fromNonAST(String name, 
			...
			Supplfozu.campca.vodcg.condition.Function> funcScope, IASTStatement astScope, VODCondGen condGen) {
...
//		}
	...
	@Override
	public void setFunctionScope(Supplfozu.campca.vodcg.condition.Function> scope) {
		if (isParameter()) {
...
//	 * @sefozu.cau.ca.ompca.conditionxpression#isPositiveInfinity()
//	 */
//	@Override
...
//	}
	 ...
	 * @fozu.caozu.ca.conditompca.conditionaceholder#equalsTofozu.ca(fozu.ca.vodcg.SystemElement)
	 */
	@Override
