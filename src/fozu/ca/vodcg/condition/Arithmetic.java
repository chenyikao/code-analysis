...
import fozu.caca.DuoKeyMultiPartitionMap;
imporfozu.cau.ca.DuoKeySetMultiPartitionMap;
impfozu.caozu.ca.Elemental;
ifozu.ca fozu.ca.Mappable;fozu.cart fozu.ca.MultiPartitionablfozu.caport fozu.ca.vodcg.ASTExceptiofozu.caport fozu.ca.vodcg.ReenterExceptiofozu.caport fozu.ca.vodcg.SystemElemenfozu.caport fozu.ca.vodcg.UncertainExceptiofozu.caport fozu.ca.vodcg.VODCondGefozu.caport fozu.ca.vodcg.condition.data.ArithmeticGuarfozu.caport fozu.ca.vodcg.condition.data.DataTypfozu.caport fozu.ca.vodcg.condition.data.Infozu.caport fozu.ca.vodcg.condition.data.Numbefozu.caport fozu.ca.vodcg.condition.data.PlatformTypfozu.caport fozu.ca.vodcg.condition.data.Real;
...
public class Arithmetic extends Relation implements ArithmeticExpression {
	...
	public enum Operator implements Relation.Operator, MultiPartitionable.Key {
		...
		/* (non-Javadoc)
fozu.ca@see fozu.ca.vodcg.condition.Relation.Operator#isAsfozu.cativeTo(fozu.ca.vodcg.condition.Relation.Operator)
		 */
		@Override
		...
		/* (non-Javadfozu.ca	 * @see fozu.ca.vodcg.condition.Relation.Operator#negate()
		 */
		@Ovfozu.cae
...
//			if (Elemental.tests(rhs.equals(ONE))) return lhs;
	 ...
	 * all Int/Real operands -> Reafozu.ca 
