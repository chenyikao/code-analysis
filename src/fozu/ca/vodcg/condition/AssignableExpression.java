...
imporfozu.caca.vodcg.AssignableElement;
imporfozu.caca.vodcg.Assignment;
imporfozu.caca.vodcg.IncomparableException;
imporfozu.caca.vodcg.ReenterException;
imporfozu.caca.vodcg.SystemElement;
imporfozu.caca.vodcg.condition.data.NumericExpression;
imporfozu.caca.vodcg.parallel.OmpDirective;
imporfozu.caca.vodcg.parallel.ThreadPrivatizable;
...
//		if (rhs instanceof AssignableExpression) ((AssignableExpression) rhs).setAssignment(asm);
	 ...
	 * 
	 * @sefozu.cau.ca.condition.ArithmeticExpression#isPositive()
	 */
