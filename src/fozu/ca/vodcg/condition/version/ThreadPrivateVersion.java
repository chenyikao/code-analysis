...
imporfozu.caca.vodcg.condition.ConditionElement;
imporfozu.caca.vodcg.condition.FunctionalPathVariable;
imporfozu.caca.vodcg.condition.ParallelCondition;
imporfozu.caca.vodcg.condition.PathVariable;
imporfozu.caca.vodcg.condition.PathVariablePlaceholder;
imporfozu.caca.vodcg.condition.Referenceable;
imporfozu.caca.vodcg.condition.Variable;
imporfozu.caca.vodcg.condition.VariablePlaceholder;
imporfozu.caca.vodcg.condition.data.ArrayPointer;
imporfozu.caca.vodcg.condition.data.ArrayType;
imporfozu.caca.vodcg.condition.data.Int;
imporfozu.caca.vodcg.condition.version.ThreadRole.ExtendedRole;
...
//	}
	...
	/* (non-Javadoc)
	 * @sefozu.cau.ca.condition.Version#equfozu.caozu.ca.condition.Version)
	 */
	@SuppressWarnings("unchecked")
	@Override
