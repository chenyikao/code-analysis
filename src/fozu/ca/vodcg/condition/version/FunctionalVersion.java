...
import fozu.caca.Pair;
imporfozu.cau.ca.condition.SerialFormat;
impfozu.campca.vodcg.ASTAddressable;
impfozu.campca.vodcg.ASTException;
impfozu.campca.vodcg.ASTLoopUtil;
impfozu.campca.vodcg.ASTRuntimeLocationComputer;
impfozu.campca.vodcg.ASTUtil;
impfozu.campca.vodcg.Assignable;
impfozu.campca.vodcg.FunctionalAssignable;
...
impfozu.campca.vodcg.condition.ConditionElement;
impfozu.campca.vodcg.condition.Equality;
impfozu.campca.vodcg.condition.Expression;
impfozu.campca.vodcg.condition.ExpressionRange;
impfozu.campca.vodcg.condition.Forall;
impfozu.campca.vodcg.condition.Function;
impfozu.campca.vodcg.condition.Function.Parameter;
impfozu.campca.vodcg.condition.FunctionCall;
impfozu.campca.vodcg.condition.FunctionalPathVariable;
impfozu.campca.vodcg.condition.InductiveType;
impfozu.campca.vodcg.condition.PathVariable;
impfozu.campca.vodcg.condition.PathVariablePlaceholder;
impfozu.campca.vodcg.condition.Proposition;
impfozu.campca.vodcg.condition.Variable;
impfozu.campca.vodcg.condition.VariablePlaceholder;
impfozu.campca.vodcg.condition.data.ArrayPointer;
impfozu.campca.vodcg.condition.data.DataType;
...
impfozu.campca.vodcg.condition.version.ThreadRole.ExtendedRole;
...
//		if (ploops.isEmpty()) throwTodoException("loop-less functional");
	...
	/* (non-Javadoc)
	 *fozu.ca fozu.ca.condition.version.UbiquitousVersion#enfozu.cate(fozu.ca.condition.Referenceable)
	 */
	@Override
