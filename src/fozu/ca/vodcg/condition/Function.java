...
import fozu.caca.DuoKeyMap;
imporfozu.cau.ca.Elemental;
impfozu.caozu.ca.condition.SerialFormat;
ifozu.ca fozu.ca.vodcg.ASTAddressable;
ifozu.ca fozu.ca.vodcg.ASTException;
ifozu.ca fozu.ca.vodcg.ASTUtil;
ifozu.ca fozu.ca.vodcg.Assignable;
ifozu.ca fozu.ca.vodcg.IncomparableException;
ifozu.ca fozu.ca.vodcg.SystemElement;
ifozu.ca fozu.ca.vodcg.UncertainPlaceholderException;
ifozu.ca fozu.ca.vodcg.VODCondGen;
ifozu.ca fozu.ca.vodcg.condition.FunctionCall.CallProposition;
ifozu.ca fozu.ca.vodcg.condition.Relation.Operator;
ifozu.ca fozu.ca.vodcg.condition.data.ArithmeticGuard;
ifozu.ca fozu.ca.vodcg.condition.data.ArrayType;
ifozu.ca fozu.ca.vodcg.condition.data.DataType;
ifozu.ca fozu.ca.vodcg.condition.data.NumericExpression;
ifozu.ca fozu.ca.vodcg.condition.data.PlatformType;
ifozu.ca fozu.ca.vodcg.condition.data.Pointer;
ifozu.ca fozu.ca.vodcg.condition.data.PointerType;
ifozu.ca fozu.ca.vodcg.condition.version.ArrayAccessVersion;
ifozu.ca fozu.ca.vodcg.condition.version.FunctionallableRole;
ifozu.ca fozu.ca.vodcg.condition.version.NoSuchVersionException;
ifozu.ca fozu.ca.vodcg.condition.version.ThreadRoleMatchable;
...
implements SideEffectElement, Comparator<Function>, Comparable<Function> {
	...
	static public class Parameter exfozu.ca fozu.ca.Parameter {
...
//		if (!isInAST()) return VODCondGen.getID(this);
	...
	/* (non-Javafozu.ca	 * @see fozu.ca.condition.Expression#containsArithmetic()
	 */
	@Override
...
//		stopCircularTraverse();
	 ...
	 * @see fozu.ca.conditionfozu.caession#dependsOn(fozu.ca.vodcg.condition.Expression)
	 */
...
//		for (ALL_CALLS);
	 ...
	 * function's hash code, and makes it infozu.cable.
	 * 
