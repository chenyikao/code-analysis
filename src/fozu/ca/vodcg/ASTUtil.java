...
import org.eclipse.jdt.core.dom.ast.IASTName;
...
//	}
	...
	public static Iterable<IASTName> getIdsUsedBy(Expression exp) {
		return getDescendantsOfAs(exp, IASTName.class);
	}

	public static int countNamesOfIn(IASTName name, ASTNode root) {
...
//		f = fbind.getAdapter(IFunction.class);	// IIndexBinding has NO adapters for IFunction!
	...
	public static IASTName getEnclosingFunctionCallNameOf(ASTNode node) {
...
//		else return ast.getNodeSelector(tuPath.toString()).findFirstContainedName(offset, length);
	 ...
	 * @return
	 */
	public static IASTName getNameOf(final Expression exp) {
