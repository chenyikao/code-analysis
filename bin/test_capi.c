...
//    fs  = Z3_parse_smtlib2_string(ctx, "(declare-fun a () (_ BitVec 8)) (assert (bvuge a #x10)) (assert (bvule a #xf0))", 0, 0, 0, 0, 0, 0);
    const Z3_sort SORTS[] = {Z3_mk_bool_sort(ctx)};
    const Z3_symbol SORT_NAMES[] = {Z3_get_sort_name(ctx, SORTS[0])};
    const Z3_symbol DECL_NAMES[] = {Z3_mk_string_symbol(ctx, "a")};
    const Z3_func_decl DECLS[] = {Z3_mk_func_decl(ctx, DECL_NAMES[0], 0, 0, SORTS[0])};
    fs  = Z3_parse_smtlib2_string(ctx, "(declare-fun a () Bool) (assert (or a (not a)))", 1, SORT_NAMES, SORTS, 1, DECL_NAMES, DECLS);
